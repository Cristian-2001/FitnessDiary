...
public class EserciziRecViewAdapter extends RecyclerView.Adapter<EserciziRecViewAdapter.ViewHolder> {
    ...
    public EserciziRecViewAdapter(Context mContext) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, @SuppressLint("RecyclerView") int position) {
        ...
        holder.parent.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(mContext, SelezionaEsercizioActivity.class);
                intent.putExtra(ES_ID_KEY, esercizi.get(position).getId());
