...
public class CibiInsRecViewAdapter extends RecyclerView.Adapter<CibiInsRecViewAdapter.ViewHolder>{
    private static final String TAG = "CibiInsRecViewAdapter";
    ...
    public CibiInsRecViewAdapter(Context mContext) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.parent.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(mContext, ModificaCiboActivity.class);
